...
uint8_t send_command(uint8_t *command,uint8_t *wait_sty,uint8_t wait_time,uint8_t *Receive_data_flag,uint8_t *rec_buf)
{
...
void get_ntp_time(uint8_t * Receive_data_flag,uint8_t *rec_buf)
{
	   ...
	   send_command(AT_CNTP,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
	   send_command(AT_CNTP_1,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
	   send_command(AT_CCLK,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
...
{           
	   ...
	   send_command("AT\r\n",(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
	   send_command(AT_SAPBR_1,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
	   send_command(AT_SAPBR_2,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
	   send_command(AT_SAPBR_3,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
     get_ntp_time(Receive_data_flag,rec_buf);
	   send_command(AT_HTTPINIT,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);
	   send_command(AT_HTTPPARA,(uint8_t *)"OK",5,Receive_data_flag,rec_buf);	
}
